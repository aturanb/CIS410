...
IL2CPP_EXTERN_C String_t* _stringLiteral7A821DC9B52E439EB99086DB1B4ECB1BE2866B21;
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void EnemyChaseSingle_Update_mF96B805225A2923B34B2E1E89F49797FFAE0F758 (EnemyChaseSingle_t708D38B464435670C687B0F0E5614B1F0EB5D6EE* __this, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		L_16 = Quaternion_LookRotation_m8C0F294E5143F93D378E020EAD9DA2288A5907A3(L_15, NULL);
		float L_17;
		L_17 = Time_get_deltaTime_m7AB6BFA101D83E1D8F2EF3D5A128AEE9DDBF1A6D(NULL);
		Quaternion_tDA59F214EF07D7700B26E40E562F267AF7306974 L_18;
		L_18 = Quaternion_Slerp_m5FDA8C178E7EB209B43845F73263AFE9C02F3949(L_9, L_16, ((float)il2cpp_codegen_multiply((5.0f), L_17)), NULL);
		...
		L_24 = Vector3_op_Multiply_m516FE285F5342F922C6EB3FCB33197E9017FF484_inline(L_23, (2.0f), NULL);
		float L_25;
...
IL_0017:
	{
		...
		bool L_2;
		L_2 = Input_GetKeyDown_m0D59B7EBC3A782C9FBBF107FBCD4B72B38D993B3(((int32_t)113), NULL);
		if (!L_2)
		{
			goto IL_0027;
		}
	...
	{
		// QuitGame();
		PauseMenu_QuitGame_m699C16B5AE66C12C48F4D7B4821169679C5FF760(__this, NULL);
		return;
	}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void PauseMenu_LoadMenu_m301E8408F8C5253F3753113332BBC089863B19A9 (PauseMenu_t36539DEACE8377BD498A235C80769301799E1985* __this, const RuntimeMethod* method) 
{
	...
	{
		il2cpp_codegen_initialize_runtime_metadata((uintptr_t*)&SceneManager_tA0EF56A88ACA4A15731AF7FDC10A869FA4C698FA_il2cpp_TypeInfo_var);
		il2cpp_codegen_initialize_runtime_metadata((uintptr_t*)&_stringLiteral7A821DC9B52E439EB99086DB1B4ECB1BE2866B21);
		s_Il2CppMethodInitialized = true;
	}
	{
		// Time.timeScale = 1f;
		...
		il2cpp_codegen_runtime_class_init_inline(SceneManager_tA0EF56A88ACA4A15731AF7FDC10A869FA4C698FA_il2cpp_TypeInfo_var);
		SceneManager_LoadScene_m7237839058F581BFCA0A79BB96F6F931469E43CF(_stringLiteral7A821DC9B52E439EB99086DB1B4ECB1BE2866B21, NULL);
		// }
		return;
	}
}
